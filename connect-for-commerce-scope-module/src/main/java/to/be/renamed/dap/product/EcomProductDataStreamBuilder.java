...
public class EcomProductDataStreamBuilder implements DataStreamBuilder<EcomProduct> {
    ...
    public EcomProductDataStreamBuilder(final EcomConnectScope scope) {
        this.scope = scope;
    ...
    @Override
    public @NotNull DataStream<EcomProduct> createDataStream() {
        return new EcomProductDataStream(scope, filterBuilder);
    }
