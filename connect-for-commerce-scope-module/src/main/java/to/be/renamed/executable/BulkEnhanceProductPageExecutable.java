...
public class BulkEnhanceProductPageExecutable extends ExecutableUtilities implements Executable {
    ...
    private boolean isProductPage(final Page page) {
        return Objects.equals(page.getFormData().get(null, "type").get(), "product");
    }

    private static EcomProduct getEcomProductFromPage(final BaseContext context, final Page page, final Language language) {
        String productId = (String) page.getFormData().get(null, "id").get();
